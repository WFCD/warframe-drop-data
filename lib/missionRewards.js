...
module.exports = function($) {
    ...
    for (let tr of tbody.children) {
        ...
        if (elem.name === "th") {
            let parsedLocation = parseLocation(text)
        ...
        if (elem.name === "td" && elem.attribs.class !== "blank-row") {
            ...
            if (!rotation) {
                ...
                addUniqueHashedObject(missionRewards[location.planet][location.location].rewards, item, ["itemName", "chance"])
            } else {
                ...
                addUniqueHashedObject(missionRewards[location.planet][location.location].rewards[rotation], item, ["itemName", "chance"])
            }
        }
    }
